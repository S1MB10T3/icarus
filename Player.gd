...
func _ready():
	...
	UI_status_label = $HUD/Gun_label
	UI_health_label = $HUD/LifeBar/TextureProgress
	UI_ability_1 = $HUD/A1_Cooldown/TextureProgress
	UI_ability_2 = $HUD/A2_Cooldown/TextureProgress
	UI_ability_3 = $HUD/A3_Cooldown/TextureProgress
	UI_gear_ability = $HUD/G_Cooldown/TextureProgress
	UI_ult_ability = $HUD/Ult_Cooldown/TextureProgress
	...
	get_tree().call_group("spawner", "set_player", self)
...
func process_input(delta):
	...
	if Input.is_action_just_pressed("switch_weps"):
		if weapon_change_number == 1:
...
func process_UI(delta):
	...
	if current_weapon_name == "UNARMED" or current_weapon_name == "KNIFE":
		...
		UI_health_label.value = health
		UI_ability_1.value = (20 - ability_one_timer)
		UI_ability_2.value = (8 - ability_two_timer)
		UI_ability_3.value = (15 - ability_three_timer)
		UI_gear_ability.value = (2 - gear_ability_timer)
	else:
		var current_weapon = weapons[current_weapon_name]
		# First line: Health, second line: weapon and ammo, third line: grenades
		UI_status_label.text = "\nAmmo:" + str(current_weapon.ammo_in_weapon) + "/" + str(current_weapon.AMMO_IN_MAG)
		UI_health_label.value = health
		UI_ability_1.value = (20 - ability_one_timer)
		UI_ability_2.value = (8 - ability_two_timer)
		UI_ability_3.value = (15 - ability_three_timer)
...
func fire_bullet():
	...
	if resOn == true:
		weapons[current_weapon_name].fire_weapon_extra_dmg()
	else:
